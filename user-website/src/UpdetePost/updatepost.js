            ...
            <>
                ...
                <div className="welcome-area">
                    <div className="post-container">
                        <h1 id="ptitle" style={{ color: "#ffff" }}>Update Post</h1>
                        <br></br>
                                    ...
                                    <Button id="signup-button" type="default"
                                        onClick={
                                            () => {
                                                ...
                                                allServicePosts.updatepost(this.state.id,cataegoryid, descreption, direction, location, nFloor, numberOfRoom, offer, ownerid, price, size, imageUrl).then(
                                                    (response) => {
